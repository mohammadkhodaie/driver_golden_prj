...
void pax::filter_bank_impl::set_filter_path_hand_off(pax::filter_bank::filter_bank_hand_off_value::FILTER_PATH_HAND_OFF path){
    ...
    case filter_bank_hand_off_value::low_pass_40MHz :{
        vAD9361[wich_ad9361_ic]->GPO_manual_set(hand_off_filter_pin_map[HAND_OFF_PIN_1],0);
        vAD9361[wich_ad9361_ic]->GPO_manual_set(hand_off_filter_pin_map[HAND_OFF_PIN_2],0);
        vAD9361[wich_ad9361_ic]->GPO_manual_set(hand_off_filter_pin_map[HAND_OFF_PIN_3],1);
        vAD9361[wich_ad9361_ic]->GPO_manual_set(hand_off_filter_pin_map[HAND_OFF_PIN_4],1);
    }break;
    case filter_bank_hand_off_value::low_pass_100MHz:   {
        vAD9361[wich_ad9361_ic]->GPO_manual_set(hand_off_filter_pin_map[HAND_OFF_PIN_1],0);
        vAD9361[wich_ad9361_ic]->GPO_manual_set(hand_off_filter_pin_map[HAND_OFF_PIN_2],0);
        vAD9361[wich_ad9361_ic]->GPO_manual_set(hand_off_filter_pin_map[HAND_OFF_PIN_3],0);
        vAD9361[wich_ad9361_ic]->GPO_manual_set(hand_off_filter_pin_map[HAND_OFF_PIN_4],0);
    }break;
    ...
    case filter_bank_hand_off_value::low_pass_450MHz:   {
        ...
        vAD9361[wich_ad9361_ic]->GPO_manual_set(hand_off_filter_pin_map[HAND_OFF_PIN_1],1);
        vAD9361[wich_ad9361_ic]->GPO_manual_set(hand_off_filter_pin_map[HAND_OFF_PIN_2],1);
        vAD9361[wich_ad9361_ic]->GPO_manual_set(hand_off_filter_pin_map[HAND_OFF_PIN_3],0);
        vAD9361[wich_ad9361_ic]->GPO_manual_set(hand_off_filter_pin_map[HAND_OFF_PIN_4],0);
    }break;
