...
#ifndef INCLUDED_PAX_EXCEPTION_HPP
#define INCLUDED_PAX_EXCEPTION_HPP
...
namespace pax{
     ...
     */
    #define PAX_THROW_SITE_INFO(what) std::string( \
        std::string(what) + "\n" + \
     ...
     */
    #define PAX_ASSERT_THROW(code) {if (not (code)) \
        throw pax::assertion_error(PAX_THROW_SITE_INFO(#code)); \
    }

} //namespace pax

#endif /* INCLUDED_PAX_EXCEPTION_HPP */
