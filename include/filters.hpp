...
namespace pax{
    ...
    class PAX_API filter_info_base
    {
    public:
    ...
    PAX_API std::ostream& operator<<(std::ostream& os, filter_info_base& f);

    class PAX_API analog_filter_base : public filter_info_base
    {
    ...
    class PAX_API analog_filter_lp : public analog_filter_base
    {
        double _cutoff;
        double _rolloff;
    ...
    class PAX_API digital_filter_base : public filter_info_base
    {
    protected:
        double _rate;
    ...
    template<typename tap_t>
    class PAX_API digital_filter_fir : public digital_filter_base<tap_t>
    {
    public:
        ...
        void set_taps(const std::vector<tap_t>& taps)
        {
            ...
            if(num_taps < this->_max_num_taps){
                std::cout << "digital_filter_fir::set_taps not enough coefficients. Appending zeros";
