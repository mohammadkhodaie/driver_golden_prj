...
{
    return converter::sptr(new convert_sc12_item32_1_to_star_1<float, pax::wtohx>());
}

static converter::sptr make_convert_sc12_item32_be_1_to_fc32_1(void)
{
    return converter::sptr(new convert_sc12_item32_1_to_star_1<float, pax::ntohx>());
}

UHD_STATIC_BLOCK(register_convert_unpack_sc12)
{
    pax::convert::register_bytes_per_item("sc12", 3/*bytes*/);
    ...
    pax::convert::register_converter(id, &make_convert_sc12_item32_le_1_to_fc32_1, PRIORITY_GENERAL);

    id.input_format = "sc12_item32_be";
    pax::convert::register_converter(id, &make_convert_sc12_item32_be_1_to_fc32_1, PRIORITY_GENERAL);
}
