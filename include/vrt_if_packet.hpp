...
namespace vrt{
     ...
     */
    struct PAX_API if_packet_info_t
    {
     ...
     * \param if_packet_info the if packet info (read/write)
     */
    PAX_API void if_hdr_unpack_le(
        const boost::uint32_t *packet_buff,
        if_packet_info_t &if_packet_info
    );

    PAX_INLINE if_packet_info_t::if_packet_info_t(void):
