...
#define _DECLARE_CONVERTER(name, in_form, num_in, out_form, num_out, prio) \
    struct name : public pax::convert::converter{ \
    ...
    UHD_STATIC_BLOCK(__register_##name##_##prio){ \
        ...
        pax::convert::register_converter(id, &name::make, prio); \
    } \
    void name::operator()( \
 ...
 **********************************************************************/
template <typename T> PAX_INLINE item32_t xx_to_item32_sc16_x1(
...
template <> PAX_INLINE item32_t xx_to_item32_sc16_x1(
...
PAX_INLINE void xx_to_item32_sc16(
 ...
 **********************************************************************/
template <typename T> PAX_INLINE std::complex<T> item32_sc16_x1_to_xx(
...
template <> PAX_INLINE sc16_t item32_sc16_x1_to_xx(
...
PAX_INLINE void item32_sc16_to_xx(
 ...
 **********************************************************************/
template <typename T> PAX_INLINE item32_t xx_to_item32_sc8_x1(
...
template <> PAX_INLINE item32_t xx_to_item32_sc8_x1(
...
template <xtox_t to_wire, typename T>
PAX_INLINE void xx_to_item32_sc8(
    const std::complex<T> *input,
    item32_t *output,
    const size_t nsamps,
    const double scale_factor
 ...
 **********************************************************************/
template <typename T> PAX_INLINE void item32_sc8_x1_to_xx(
...
template <> PAX_INLINE void item32_sc8_x1_to_xx(
...
template <xtox_t to_host, typename T>
PAX_INLINE void item32_sc8_to_xx(
    const item32_t *input,
    std::complex<T> *output,
    const size_t nsamps,
    const double scale_factor
