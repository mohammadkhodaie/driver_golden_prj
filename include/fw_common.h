...
#define USRP2_UDP_CTRL_PORT 49140
//#define USRP2_UDP_UPDATE_PORT 49154
#define PAX8_UDP_RX_DSP0_PORT 49200
#define PAX8_UDP_RX_DSP_PORT(x) (PAX8_UDP_RX_DSP0_PORT+x)

#define PAX8_UDP_TX_DSP0_PORT 49216
#define PAX8_UDP_TX_DSP_PORT(x) (PAX8_UDP_TX_DSP0_PORT+x)
...
#define U2_FW_REG_FLASH_TYPE 4
#define U2_FW_REG_FLASH_INTERFACE_TYPE 5
#define U2_FW_REG_VER_MINOR 7
#define U2_SR_SFC_PORT_REG 18
...
typedef enum{
    ...
    PAX_CTRL_ID_TRANSACT_BPI_BRO='b',
    PAX_CTRL_ID_TRANSACTED_BPI_DUDE='B',

    PAX_CTRL_ID_TRANSACT_SPIF_BRO='f',
    PAX_CTRL_ID_TRANSACTED_SPIF_DUDE='F',
