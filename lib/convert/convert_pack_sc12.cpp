...
{
    return converter::sptr(new convert_star_1_to_sc12_item32_1<float, pax::wtohx>());
}

static converter::sptr make_convert_fc32_1_to_sc12_item32_be_1(void)
{
    return converter::sptr(new convert_star_1_to_sc12_item32_1<float, pax::ntohx>());
}
...
UHD_STATIC_BLOCK(register_convert_pack_sc12)
{
    ...
    pax::convert::register_converter(id, &make_convert_fc32_1_to_sc12_item32_le_1, PRIORITY_GENERAL);

    id.output_format = "sc12_item32_be";
    pax::convert::register_converter(id, &make_convert_fc32_1_to_sc12_item32_be_1, PRIORITY_GENERAL);
}
