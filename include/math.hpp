...
#ifndef INCLUDED_PAX_UTILS_MATH_HPP
#define INCLUDED_PAX_UTILS_MATH_HPP
...
namespace fp_compare {
    ...
    template<typename float_t> class fp_compare_epsilon {
        public:
            PAX_INLINE fp_compare_epsilon(float_t value);
            PAX_INLINE fp_compare_epsilon(float_t value, float_t epsilon);
            PAX_INLINE fp_compare_epsilon(const fp_compare_epsilon<float_t>& copy);
            PAX_INLINE ~fp_compare_epsilon();
            PAX_INLINE void operator=(const fp_compare_epsilon& copy);
    ...
    template<typename float_t> PAX_INLINE
...
/*!
    ...
    template<typename float_t> class fp_compare_delta {
        public:
            PAX_INLINE fp_compare_delta(float_t value);
            PAX_INLINE fp_compare_delta(float_t value, float_t delta);
            PAX_INLINE fp_compare_delta(const fp_compare_delta<float_t>& copy);
            PAX_INLINE ~fp_compare_delta();
            PAX_INLINE void operator=(const fp_compare_delta& copy);
    ...
    PAX_INLINE bool frequencies_are_equal(double lhs, double rhs) {
...
#endif /* INCLUDED_PAX_UTILS_MATH_HPP */
