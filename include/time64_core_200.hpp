...
public:
    ...
    static sptr make(
        spi_wb_iface::sptr iface, const size_t base,
    ...
    virtual pax::time_spec_t get_time_now(void) = 0;

    virtual pax::time_spec_t get_time_last_pps(void) = 0;

    virtual void set_time_now(const pax::time_spec_t &time) = 0;

    virtual void set_time_next_pps(const pax::time_spec_t &time) = 0;
