...
#ifndef INCLUDED_PAX_UTILS_ALGORITHM_HPP
#define INCLUDED_PAX_UTILS_ALGORITHM_HPP
...
namespace pax{
     ...
     */
    template<typename Range> PAX_INLINE Range sorted(const Range &range){
     ...
     */
    template<typename Range> PAX_INLINE Range reversed(const Range &range){
     ...
     */
    template<typename Range, typename T> PAX_INLINE
     ...
     */
    template<typename T> PAX_INLINE T clip(const T &val, const T &bound1, const T &bound2){
