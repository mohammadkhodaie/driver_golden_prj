...
public:
    ...
    void initialize(lo_mode_t set_lo_mode);
    ...
    void digital_test_prbs(bool enb); // Digital output
     ...
     * SBM
     * */
    void set_rx_lo_source(lo_mode_t extint);
    void set_tx_lo_source(lo_mode_t extint);
    void set_delay(boost::int32_t clk, boost::int32_t data);

    /* Do Multi-Chip Sync. step
     * SBM
     * */
...
private:    //Methods
    /* SBM */ void _ext_lo_ctrl(direction_t direction, const lo_mode_t mode);
    ...
    /* SBM */ // added direction support
    void _calibrate_synth_charge_pumps(direction_t direction);
    ...
    /* SBM */ //void _setup_synth(direction_t direction, double vcorate);
    void _setup_synth(direction_t direction, double vcorate, double fref); // decide which table to use based on fref
...
private:    //Members
    ...
    // LO mode
    lo_mode_t _use_ext_rx_lo;
    lo_mode_t _use_ext_tx_lo;
