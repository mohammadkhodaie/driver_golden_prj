...
DECLARE_CONVERTER(fc32, 1, sc16_item32_le, 1, PRIORITY_SIMD){
    ...
    case 0x8:
        ...
        xx_to_item32_sc16<pax::htowx>(input, output, 1, scale_factor);
        i++;
    ...
    xx_to_item32_sc16<pax::htowx>(input+i, output+i, nsamps-i, scale_factor);
}
...
DECLARE_CONVERTER(fc32, 1, sc16_item32_be, 1, PRIORITY_SIMD){
    ...
    case 0x8:
        ...
        xx_to_item32_sc16<pax::htonx>(input, output, 1, scale_factor);
        i++;
    ...
    // convert any remaining samples
    xx_to_item32_sc16<pax::htonx>(input+i, output+i, nsamps-i, scale_factor);
}
