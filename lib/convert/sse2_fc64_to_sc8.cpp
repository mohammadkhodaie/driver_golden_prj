...
PAX_INLINE __m128i pack_sc8_item32_4x(
...
PAX_INLINE __m128i pack_sc32_4x(
...
DECLARE_CONVERTER(fc64, 1, sc8_item32_be, 1, PRIORITY_SIMD){
    ...
    //convert remainder
    xx_to_item32_sc8<pax::htonx>(input+i, output+(i/2), nsamps-i, scale_factor);
}
...
DECLARE_CONVERTER(fc64, 1, sc8_item32_le, 1, PRIORITY_SIMD){
    ...
    //convert remainder
    xx_to_item32_sc8<pax::htowx>(input+i, output+(i/2), nsamps-i, scale_factor);
}
