...
/***********************************************************************
 * This file was generated by /home/parto/Documents/uhd-master/host/lib/transport/gen_vrt_if_packet.py on Wed Jan  7 16:40:29 2015
 **********************************************************************/
...
//define the endian macros to convert integers
    ...
    #define BE_MACRO(x) (x)
    #define LE_MACRO(x) pax::byteswap(x)
#else
    #define BE_MACRO(x) pax::byteswap(x)
    #define LE_MACRO(x) (x)
#endif

using namespace pax;
using namespace pax::transport;
using namespace pax::transport::vrt;
...
PAX_INLINE static boost::uint32_t chdr_to_vrt(const boost::uint32_t chdr, if_packet_info_t &info)
{
...
PAX_INLINE static boost::uint32_t vrt_to_chdr(const boost::uint32_t vrt, const if_packet_info_t &info)
{
 ...
 **********************************************************************/
PAX_INLINE void __if_hdr_pack_be(
 ...
 **********************************************************************/
PAX_INLINE void __if_hdr_unpack_be(
    ...
    if (if_packet_info.num_packet_words32 < packet_words32)
        throw pax::value_error("bad vrt header or packet fragment");
    ...
    case 0:
            ...
            if (packet_words32 < 1)
                throw pax::value_error("bad vrt header or invalid packet length");
            if_packet_info.num_header_words32 = 1;
...
void vrt::if_hdr_pack_be(
    ...
    case if_packet_info_t::LINK_TYPE_VRLP:
        ...
        packet_buff[1] = BE_MACRO(boost::uint32_t(
...
void vrt::if_hdr_unpack_be(
    ...
    case if_packet_info_t::LINK_TYPE_CHDR:
    {
        const boost::uint32_t chdr = BE_MACRO(packet_buff[0]);
    ...
    case if_packet_info_t::LINK_TYPE_VRLP:
    {
        if (BE_MACRO(packet_buff[0]) != VRLP) throw pax::value_error("bad vrl header VRLP");
        const boost::uint32_t vrl_hdr = BE_MACRO(packet_buff[1]);
        vrt_hdr_word32 = BE_MACRO(packet_buff[2]);
        if (if_packet_info.num_packet_words32 < (vrl_hdr & 0xfffff)) throw pax::value_error("bad vrl header or packet fragment");
        if (BE_MACRO(packet_buff[(vrl_hdr & 0xfffff)-1]) != VEND) throw pax::value_error("bad vrl trailer VEND");
 ...
 * interal impl of packing VRT IF header only
 **********************************************************************/
PAX_INLINE void __if_hdr_pack_le(
    boost::uint32_t *packet_buff,
    if_packet_info_t &if_packet_info,
    boost::uint32_t &vrt_hdr_word32
){
 ...
 * interal impl of unpacking VRT IF header only
 **********************************************************************/
PAX_INLINE void __if_hdr_unpack_le(
    const boost::uint32_t *packet_buff,
    if_packet_info_t &if_packet_info,
    const boost::uint32_t vrt_hdr_word32
){
...
void vrt::if_hdr_pack_le(
    ...
    case if_packet_info_t::LINK_TYPE_VRLP:
        ...
        packet_buff[1] = LE_MACRO(boost::uint32_t(
            (if_packet_info.num_packet_words32 & 0xfffff) |
            ((if_packet_info.packet_count & 0xfff) << 20)
        ));
...
void vrt::if_hdr_unpack_le(
    ...
    case if_packet_info_t::LINK_TYPE_CHDR:
    {
        const boost::uint32_t chdr = LE_MACRO(packet_buff[0]);
        vrt_hdr_word32 = chdr_to_vrt(chdr, if_packet_info);
        size_t packet_count = if_packet_info.packet_count;
        __if_hdr_unpack_le(packet_buff, if_packet_info, vrt_hdr_word32);
        if_packet_info.num_payload_bytes -= (~chdr + 1) & 0x3;
    ...
    case if_packet_info_t::LINK_TYPE_VRLP:
    {
        if (LE_MACRO(packet_buff[0]) != VRLP) throw pax::value_error("bad vrl header VRLP");
        const boost::uint32_t vrl_hdr = LE_MACRO(packet_buff[1]);
        vrt_hdr_word32 = LE_MACRO(packet_buff[2]);
        if (if_packet_info.num_packet_words32 < (vrl_hdr & 0xfffff)) throw pax::value_error("bad vrl header or packet fragment");
        if (LE_MACRO(packet_buff[(vrl_hdr & 0xfffff)-1]) != VEND) throw pax::value_error("bad vrl trailer VEND");
