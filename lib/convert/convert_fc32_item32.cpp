...
{ \
    ...
    pax::convert::register_converter(id, &make_convert_ ## itype ## _1_ ## otype ## _1, PRIORITY_GENERAL); \
}

__make_registrations(fc32_item32_le, fc32, convert_fc32_item32_1_to_star_1, float, pax::wtohx)
__make_registrations(fc32_item32_be, fc32, convert_fc32_item32_1_to_star_1, float, pax::ntohx)
__make_registrations(fc32_item32_le, fc64, convert_fc32_item32_1_to_star_1, double, pax::wtohx)
__make_registrations(fc32_item32_be, fc64, convert_fc32_item32_1_to_star_1, double, pax::ntohx)

__make_registrations(fc32, fc32_item32_le, convert_star_1_to_fc32_item32_1, float, pax::wtohx)
__make_registrations(fc32, fc32_item32_be, convert_star_1_to_fc32_item32_1, float, pax::ntohx)
__make_registrations(fc64, fc32_item32_le, convert_star_1_to_fc32_item32_1, double, pax::wtohx)
__make_registrations(fc64, fc32_item32_be, convert_star_1_to_fc32_item32_1, double, pax::ntohx)
