...
namespace pax{
     ...
     */
    class PAX_API reusable_barrier{
    public:
        ...
        //! Wait on the barrier condition
        PAX_INLINE void wait_others(void)
        {
    ...
    private:
       ...
       PAX_INLINE void check_interrupt(void)
        {
     ...
     */
    PAX_INLINE bool spin_wait_with_timeout(
    ...
    public:
       ...
       PAX_INLINE void release(void){
            _locked.write(0);
        }

        PAX_INLINE bool claim_with_wait(const double timeout){
